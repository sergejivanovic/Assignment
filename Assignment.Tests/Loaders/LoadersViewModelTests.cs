...
namespace Assignment.Tests.Loaders
{
    ...
    public class LoadersViewModelTests
    {
        ...
        public void TotalProgress_WhenOneThreadCancelled_ExcludesCancelledThread()
        {
            ...
            var vm = new LoadersViewModel();
            vm.Threads[0].Elapsed = 40; // da bude 40%
            vm.Threads[1].Elapsed = 60; // da bude 60%
            vm.Threads[2].Elapsed = 80; // da bude 80%

            vm.Threads[0].Duration = 100;
            vm.Threads[1].Duration = 100;
            vm.Threads[2].Duration = 100;
